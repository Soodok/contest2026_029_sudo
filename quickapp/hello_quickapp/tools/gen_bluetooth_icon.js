...
const BG = 'rgba(183,28,28,0.55)'   // 半透明暗红圆底（黑底上合成=暗红半透观感，主人第 4 版要求）
const FG = '#FF5252'                // 亮红蓝牙符号（半透暗红底上清晰可辨，不再红对红糊成一团）

const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 256 256">
  <defs>
    <clipPath id="circleClip"><circle cx="128" cy="128" r="120"/></clipPath>
    <!-- 留空斜缝遮罩：白=保留，黑斜线=挖去。⚠️ 作用于【整组（圆底+符号）】——
         缝里完全透明（透出页面背景）= 主人描述的「留空」斜杠（非线条绘制、非透底色） -->
    <mask id="slashCut">
      <rect x="0" y="0" width="256" height="256" fill="#FFFFFF"/>
      <line x1="14" y1="14" x2="242" y2="242" stroke="#000000" stroke-width="34" stroke-linecap="butt"/>
    </mask>
  </defs>
  <g clip-path="url(#circleClip)" mask="url(#slashCut)">
    <circle cx="128" cy="128" r="120" fill="${BG}"/>
    <!-- 亮红蓝牙符号（Material 官方 24x24 path，scale 8 居中） -->
...
console.log('✅ bluetooth_off.png 第 4 版（' + png.length + 'B，128x128）：半透明暗红底 + 亮红符号 + 贯穿留空斜缝')
